...
public class GroupsActivity extends AppCompatActivity {
   ...
   //Dialog
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myViewModel.getGroupList().observe(this, new Observer<List<ChatGroup>>() {
            ...
            public void onChanged(List<ChatGroup> chatGroups) {
                //the updated data is received as "chatGroups" parameter is onChanged()
    ...
    public void showDialog()
    {
        ...
        EditText edt=view.findViewById(R.id.chat_group_et);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(GroupsActivity.this, "Your Chat Group: "+groupName
